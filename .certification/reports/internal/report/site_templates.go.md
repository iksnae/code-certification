...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/report/site_templates.go` |
| **Type** | file |
| **Path** | `internal/report/site_templates.go` |
| **Language** | go |
...
412 lines (373 code, 10 comment, 29 blank), 0 TODOs, complexity 0
...
per-unit coverage: 48%

| Metric | Value |
|--------|------:|
| `unit_test_coverage` | 0.48 |
