...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/report/card.go#PassRateKnown` |
| **Type** | method |
...
5 lines (1 code, 4 comment, 0 blank), 0 TODOs, complexity 1
...
deep: fan_in=5 fan_out=0 dead=true depth=2 instab=0.50
