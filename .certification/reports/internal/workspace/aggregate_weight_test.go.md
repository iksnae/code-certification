...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/workspace/aggregate_weight_test.go` |
| **Type** | file |
| **Path** | `internal/workspace/aggregate_weight_test.go` |
| **Language** | go |
...
44 lines (20 code, 19 comment, 5 blank), 0 TODOs, complexity 0
