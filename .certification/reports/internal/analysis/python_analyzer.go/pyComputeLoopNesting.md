...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/analysis/python_analyzer.go#pyComputeLoopNesting` |
| **Type** | function |
| **Path** | `internal/analysis/python_analyzer.go` |
| **Language** | go |
| **Symbol** | `pyComputeLoopNesting` |
...
23 lines (23 code, 0 comment, 0 blank), 0 TODOs, complexity 6
