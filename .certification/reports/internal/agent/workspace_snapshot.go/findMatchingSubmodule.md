...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/agent/workspace_snapshot.go#findMatchingSubmodule` |
| **Type** | function |
| **Path** | `internal/agent/workspace_snapshot.go` |
| **Language** | go |
| **Symbol** | `findMatchingSubmodule` |
...
13 lines (10 code, 3 comment, 0 blank), 0 TODOs, complexity 3
...
structural: params=2 returns=2 nesting=1 doc=true exported=false cognitive=2
