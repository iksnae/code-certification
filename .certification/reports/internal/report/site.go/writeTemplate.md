...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/report/site.go#writeTemplate` |
| **Type** | function |
| **Path** | `internal/report/site.go` |
| **Language** | go |
| **Symbol** | `writeTemplate` |
...
structural: params=3 returns=1 nesting=1 doc=false exported=false cognitive=1
...
deep: fan_in=3 fan_out=3 dead=false depth=2 instab=0.50
