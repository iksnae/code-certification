...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/report/mixed_population_test.go` |
| **Type** | file |
| **Path** | `internal/report/mixed_population_test.go` |
| **Language** | go |
...
154 lines (119 code, 20 comment, 15 blank), 0 TODOs, complexity 0
