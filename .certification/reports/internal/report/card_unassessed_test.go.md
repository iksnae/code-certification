...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/report/card_unassessed_test.go` |
| **Type** | file |
| **Path** | `internal/report/card_unassessed_test.go` |
| **Language** | go |
...
246 lines (190 code, 33 comment, 23 blank), 0 TODOs, complexity 0
