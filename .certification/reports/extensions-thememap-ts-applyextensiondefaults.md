...
[← Back to Report Card](../REPORT_CARD.md#extensions-thememap-ts-applyextensiondefaults)
...
| Field | Value |
|-------|-------|
| **Unit ID** | `ts://extensions/themeMap.ts#applyExtensionDefaults` |
| **Type** | function |
| **Path** | `extensions/themeMap.ts` |
| **Language** | ts |
| **Symbol** | `applyExtensionDefaults` |
