...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/analysis/go_refine.go#InterfaceSize` |
| **Type** | method |
| **Path** | `internal/analysis/go_refine.go` |
| **Language** | go |
| **Symbol** | `InterfaceSize` |
...
56 lines (45 code, 6 comment, 5 blank), 0 TODOs, complexity 14
...
structural: params=2 returns=1 nesting=4 doc=true exported=true cognitive=23
...
deep: fan_in=1 fan_out=11 dead=false depth=1 instab=0.29
