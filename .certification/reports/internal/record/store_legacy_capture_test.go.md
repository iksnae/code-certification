...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/record/store_legacy_capture_test.go` |
| **Type** | file |
| **Path** | `internal/record/store_legacy_capture_test.go` |
| **Language** | go |
...
122 lines (86 code, 29 comment, 7 blank), 0 TODOs, complexity 0
