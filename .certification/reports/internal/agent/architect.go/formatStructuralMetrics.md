...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/agent/architect.go#formatStructuralMetrics` |
| **Type** | function |
| **Path** | `internal/agent/architect.go` |
| **Language** | go |
| **Symbol** | `formatStructuralMetrics` |
...
23 lines (23 code, 0 comment, 0 blank), 0 TODOs, complexity 1
