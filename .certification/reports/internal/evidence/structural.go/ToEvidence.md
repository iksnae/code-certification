...
56 lines (53 code, 1 comment, 2 blank), 0 TODOs, complexity 6
...
structural: params=0 returns=1 nesting=1 doc=true exported=true cognitive=5
...
deep: fan_in=6 fan_out=0 dead=true depth=1 instab=0.25
