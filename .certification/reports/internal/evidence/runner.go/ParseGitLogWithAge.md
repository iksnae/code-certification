...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/evidence/runner.go#ParseGitLogWithAge` |
| **Type** | function |
| **Path** | `internal/evidence/runner.go` |
| **Language** | go |
| **Symbol** | `ParseGitLogWithAge` |
...
structural: params=2 returns=1 nesting=2 doc=true exported=true cognitive=3
