# 🟢 `store_legacy_unsupported_test.go`
...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/record/store_legacy_unsupported_test.go` |
| **Type** | file |
| **Path** | `internal/record/store_legacy_unsupported_test.go` |
| **Language** | go |
...
188 lines (137 code, 33 comment, 18 blank), 0 TODOs, complexity 0
