...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/queue/queue.go#Stats` |
| **Type** | class |
...
24 lines (23 code, 1 comment, 0 blank), 0 TODOs, complexity 8
...
structural: params=0 returns=1 nesting=3 doc=true exported=true cognitive=7
