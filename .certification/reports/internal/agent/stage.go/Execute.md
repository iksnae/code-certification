...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/agent/stage.go#Execute` |
| **Type** | method |
...
42 lines (36 code, 3 comment, 3 blank), 0 TODOs, complexity 4
...
structural: params=2 returns=3 nesting=1 doc=true exported=true cognitive=3
