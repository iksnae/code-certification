...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/agent/fallback.go#Chat` |
| **Type** | method |
...
22 lines (17 code, 5 comment, 0 blank), 0 TODOs, complexity 7
...
structural: params=2 returns=2 nesting=2 doc=false exported=true cognitive=7
