...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/engine/scorer.go#StatusFromScore` |
| **Type** | function |
| **Path** | `internal/engine/scorer.go` |
| **Language** | go |
| **Symbol** | `StatusFromScore` |
...
17 lines (15 code, 1 comment, 1 blank), 0 TODOs, complexity 5
...
deep: fan_in=1 fan_out=0 dead=true depth=3 instab=0.91
