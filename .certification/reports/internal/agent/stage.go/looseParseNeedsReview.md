...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/agent/stage.go#looseParseNeedsReview` |
| **Type** | function |
| **Path** | `internal/agent/stage.go` |
| **Language** | go |
| **Symbol** | `looseParseNeedsReview` |
...
30 lines (24 code, 4 comment, 2 blank), 0 TODOs, complexity 5
