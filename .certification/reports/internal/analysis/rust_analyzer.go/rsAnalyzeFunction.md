...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/analysis/rust_analyzer.go#rsAnalyzeFunction` |
| **Type** | function |
| **Path** | `internal/analysis/rust_analyzer.go` |
| **Language** | go |
| **Symbol** | `rsAnalyzeFunction` |
...
52 lines (44 code, 4 comment, 4 blank), 0 TODOs, complexity 15
...
deep: fan_in=1 fan_out=15 dead=false depth=1 instab=0.29
