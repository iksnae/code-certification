...
61 lines (44 code, 9 comment, 8 blank), 0 TODOs, complexity 7
...
structural: params=5 returns=1 nesting=2 doc=true exported=true cognitive=4
...
deep: fan_in=1 fan_out=8 dead=true depth=2 instab=0.90
