...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/analysis/go_analyzer.go#goDetectUnsafeImports` |
| **Type** | function |
| **Path** | `internal/analysis/go_analyzer.go` |
| **Language** | go |
| **Symbol** | `goDetectUnsafeImports` |
...
10 lines (10 code, 0 comment, 0 blank), 0 TODOs, complexity 4
