...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/analysis/python_analyzer.go#Discover` |
| **Type** | method |
...
structural: params=2 returns=2 nesting=1 doc=true exported=true cognitive=2
...
deep: fan_in=0 fan_out=8 dead=true depth=1 instab=0.29
