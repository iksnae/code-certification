...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/queue/queue.go#BatchNext` |
| **Type** | method |
...
15 lines (14 code, 1 comment, 0 blank), 0 TODOs, complexity 6
...
deep: fan_in=0 fan_out=1 dead=true depth=0 instab=0.00
