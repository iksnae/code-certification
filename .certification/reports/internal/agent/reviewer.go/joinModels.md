...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/agent/reviewer.go#joinModels` |
| **Type** | function |
...
19 lines (18 code, 1 comment, 0 blank), 0 TODOs, complexity 5
...
deep: fan_in=0 fan_out=0 dead=false depth=1 instab=0.20
