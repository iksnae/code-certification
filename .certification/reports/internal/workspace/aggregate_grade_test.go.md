...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/workspace/aggregate_grade_test.go` |
| **Type** | file |
| **Path** | `internal/workspace/aggregate_grade_test.go` |
| **Language** | go |
...
138 lines (93 code, 30 comment, 15 blank), 0 TODOs, complexity 0
