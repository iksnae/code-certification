...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/agent/architect.go#formatDeepAnalysisMetrics` |
| **Type** | function |
| **Path** | `internal/agent/architect.go` |
| **Language** | go |
| **Symbol** | `formatDeepAnalysisMetrics` |
...
24 lines (24 code, 0 comment, 0 blank), 0 TODOs, complexity 2
