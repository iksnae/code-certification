...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/engine/pipeline_unsupported_test.go` |
| **Type** | file |
| **Path** | `internal/engine/pipeline_unsupported_test.go` |
| **Language** | go |
...
94 lines (71 code, 13 comment, 10 blank), 0 TODOs, complexity 0
