...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/evidence/structural.go#AnalyzeGoFile` |
| **Type** | function |
| **Path** | `internal/evidence/structural.go` |
| **Language** | go |
| **Symbol** | `AnalyzeGoFile` |
...
28 lines (22 code, 2 comment, 4 blank), 0 TODOs, complexity 8
...
structural: params=1 returns=1 nesting=3 doc=true exported=true cognitive=8
