...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/analysis/go_analyzer.go#goWalkStmt` |
| **Type** | function |
...
structural: params=3 returns=0 nesting=2 doc=false exported=false cognitive=3
...
deep: fan_in=2 fan_out=3 dead=false depth=1 instab=0.29
