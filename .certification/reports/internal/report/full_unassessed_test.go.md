...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/report/full_unassessed_test.go` |
| **Type** | file |
| **Path** | `internal/report/full_unassessed_test.go` |
| **Language** | go |
...
135 lines (108 code, 13 comment, 14 blank), 0 TODOs, complexity 0
