...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/github/pr_unsupported_test.go` |
| **Type** | file |
| **Path** | `internal/github/pr_unsupported_test.go` |
| **Language** | go |
...
157 lines (111 code, 25 comment, 21 blank), 0 TODOs, complexity 0
