...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/analysis/python_analyzer_test.go` |
| **Type** | file |
| **Path** | `internal/analysis/python_analyzer_test.go` |
| **Language** | go |
...
205 lines (172 code, 0 comment, 33 blank), 0 TODOs, complexity 0
