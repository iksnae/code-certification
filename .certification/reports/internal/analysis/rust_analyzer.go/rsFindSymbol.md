...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/analysis/rust_analyzer.go#rsFindSymbol` |
| **Type** | function |
...
37 lines (37 code, 0 comment, 0 blank), 0 TODOs, complexity 17
...
structural: params=3 returns=1 nesting=5 doc=false exported=false cognitive=36
...
- cognitive_complexity: 36 exceeds threshold 25
