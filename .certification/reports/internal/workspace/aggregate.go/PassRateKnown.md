...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/workspace/aggregate.go#PassRateKnown` |
| **Type** | method |
| **Path** | `internal/workspace/aggregate.go` |
| **Language** | go |
| **Symbol** | `PassRateKnown` |
...
2 lines (1 code, 1 comment, 0 blank), 0 TODOs, complexity 1
...
deep: fan_in=3 fan_out=0 dead=true depth=3 instab=0.75
