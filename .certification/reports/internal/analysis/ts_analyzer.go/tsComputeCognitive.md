...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/analysis/ts_analyzer.go#tsComputeCognitive` |
| **Type** | function |
| **Path** | `internal/analysis/ts_analyzer.go` |
| **Language** | go |
| **Symbol** | `tsComputeCognitive` |
...
45 lines (39 code, 1 comment, 5 blank), 0 TODOs, complexity 14
...
structural: params=2 returns=1 nesting=4 doc=false exported=false cognitive=18
...
deep: fan_in=8 fan_out=4 dead=false depth=1 instab=0.29
