...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/analysis/ts_analyzer.go#tsNodeName` |
| **Type** | function |
...
9 lines (9 code, 0 comment, 0 blank), 0 TODOs, complexity 5
...
deep: fan_in=17 fan_out=4 dead=false depth=1 instab=0.29
