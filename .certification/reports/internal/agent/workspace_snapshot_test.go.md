...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/agent/workspace_snapshot_test.go` |
| **Type** | file |
| **Path** | `internal/agent/workspace_snapshot_test.go` |
| **Language** | go |
...
400 lines (323 code, 17 comment, 60 blank), 0 TODOs, complexity 0
