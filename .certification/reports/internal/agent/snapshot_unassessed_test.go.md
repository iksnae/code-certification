...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/agent/snapshot_unassessed_test.go` |
| **Type** | file |
| **Path** | `internal/agent/snapshot_unassessed_test.go` |
| **Language** | go |
...
124 lines (94 code, 19 comment, 11 blank), 0 TODOs, complexity 0
