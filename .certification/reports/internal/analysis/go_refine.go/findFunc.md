...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/analysis/go_refine.go#findFunc` |
| **Type** | method |
...
19 lines (18 code, 1 comment, 0 blank), 0 TODOs, complexity 6
...
structural: params=2 returns=2 nesting=3 doc=true exported=false cognitive=10
