...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/report/architect_report.go#writeArchPartIII` |
| **Type** | function |
| **Path** | `internal/report/architect_report.go` |
| **Language** | go |
| **Symbol** | `writeArchPartIII` |
...
40 lines (35 code, 1 comment, 4 blank), 0 TODOs, complexity 11
...
structural: params=2 returns=0 nesting=3 doc=false exported=false cognitive=17
