...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/analysis/go_analyzer.go#Analyze` |
| **Type** | method |
...
56 lines (46 code, 5 comment, 5 blank), 0 TODOs, complexity 14
...
structural: params=3 returns=2 nesting=3 doc=true exported=true cognitive=14
