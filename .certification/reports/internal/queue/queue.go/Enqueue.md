...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/queue/queue.go#Enqueue` |
| **Type** | method |
...
16 lines (15 code, 1 comment, 0 blank), 0 TODOs, complexity 2
...
structural: params=2 returns=0 nesting=1 doc=true exported=true cognitive=1
