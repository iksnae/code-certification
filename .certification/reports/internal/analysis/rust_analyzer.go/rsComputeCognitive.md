...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/analysis/rust_analyzer.go#rsComputeCognitive` |
| **Type** | function |
| **Path** | `internal/analysis/rust_analyzer.go` |
| **Language** | go |
| **Symbol** | `rsComputeCognitive` |
...
28 lines (28 code, 0 comment, 0 blank), 0 TODOs, complexity 9
...
deep: fan_in=6 fan_out=4 dead=false depth=1 instab=0.29
