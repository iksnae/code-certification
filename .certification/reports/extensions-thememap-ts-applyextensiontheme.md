...
[← Back to Report Card](../REPORT_CARD.md#extensions-thememap-ts-applyextensiontheme)
...
| Field | Value |
|-------|-------|
| **Unit ID** | `ts://extensions/themeMap.ts#applyExtensionTheme` |
| **Type** | function |
| **Path** | `extensions/themeMap.ts` |
| **Language** | ts |
| **Symbol** | `applyExtensionTheme` |
