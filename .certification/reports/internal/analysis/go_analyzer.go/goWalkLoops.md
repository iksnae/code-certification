...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/analysis/go_analyzer.go#goWalkLoops` |
| **Type** | function |
...
30 lines (30 code, 0 comment, 0 blank), 0 TODOs, complexity 8
...
structural: params=4 returns=0 nesting=1 doc=false exported=false cognitive=1
...
deep: fan_in=3 fan_out=1 dead=false depth=1 instab=0.29
