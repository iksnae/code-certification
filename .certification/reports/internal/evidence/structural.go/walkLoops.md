...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/evidence/structural.go#walkLoops` |
| **Type** | function |
...
31 lines (30 code, 1 comment, 0 blank), 0 TODOs, complexity 8
...
structural: params=4 returns=0 nesting=1 doc=true exported=false cognitive=1
