...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/evidence/runner.go#ParseGoTestJSON` |
| **Type** | function |
| **Path** | `internal/evidence/runner.go` |
| **Language** | go |
| **Symbol** | `ParseGoTestJSON` |
...
36 lines (32 code, 1 comment, 3 blank), 0 TODOs, complexity 9
...
structural: params=1 returns=1 nesting=2 doc=true exported=true cognitive=10
