...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/analysis/lsp_analyzer.go#FanOut` |
| **Type** | method |
...
15 lines (12 code, 1 comment, 2 blank), 0 TODOs, complexity 4
...
deep: fan_in=0 fan_out=4 dead=true depth=1 instab=0.29
