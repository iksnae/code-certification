...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/engine/artifacts_unassessed_test.go` |
| **Type** | file |
| **Path** | `internal/engine/artifacts_unassessed_test.go` |
| **Language** | go |
...
95 lines (79 code, 6 comment, 10 blank), 0 TODOs, complexity 0
