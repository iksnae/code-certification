...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/analysis/go_analyzer.go#Discover` |
| **Type** | method |
...
53 lines (47 code, 1 comment, 5 blank), 0 TODOs, complexity 11
...
structural: params=2 returns=2 nesting=4 doc=true exported=true cognitive=19
