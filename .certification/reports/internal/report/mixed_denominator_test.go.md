...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/report/mixed_denominator_test.go` |
| **Type** | file |
| **Path** | `internal/report/mixed_denominator_test.go` |
| **Language** | go |
...
250 lines (179 code, 49 comment, 22 blank), 0 TODOs, complexity 0
