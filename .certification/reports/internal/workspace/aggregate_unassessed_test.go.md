...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/workspace/aggregate_unassessed_test.go` |
| **Type** | file |
| **Path** | `internal/workspace/aggregate_unassessed_test.go` |
| **Language** | go |
...
78 lines (60 code, 8 comment, 10 blank), 0 TODOs, complexity 0
