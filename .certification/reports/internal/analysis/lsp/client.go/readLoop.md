...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/analysis/lsp/client.go#readLoop` |
| **Type** | method |
...
27 lines (25 code, 2 comment, 0 blank), 0 TODOs, complexity 7
...
structural: params=0 returns=0 nesting=4 doc=true exported=false cognitive=16
