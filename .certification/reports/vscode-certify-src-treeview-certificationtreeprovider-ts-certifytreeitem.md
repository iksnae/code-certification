...
[← Back to Report Card](../REPORT_CARD.md#vscode-certify-src-treeview-certificationtreeprovider-ts-certifytreeitem)
...
| Field | Value |
|-------|-------|
| **Unit ID** | `ts://vscode-certify/src/treeView/CertificationTreeProvider.ts#CertifyTreeItem` |
| **Type** | class |
| **Path** | `vscode-certify/src/treeView/CertificationTreeProvider.ts` |
| **Language** | ts |
| **Symbol** | `CertifyTreeItem` |
