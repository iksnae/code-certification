...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/agent/architect.go#formatSnapshotMetrics` |
| **Type** | function |
| **Path** | `internal/agent/architect.go` |
| **Language** | go |
| **Symbol** | `formatSnapshotMetrics` |
...
14 lines (13 code, 0 comment, 1 blank), 0 TODOs, complexity 4
...
structural: params=2 returns=0 nesting=2 doc=false exported=false cognitive=3
