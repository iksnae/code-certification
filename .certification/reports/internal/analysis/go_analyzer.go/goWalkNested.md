...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/analysis/go_analyzer.go#goWalkNested` |
| **Type** | function |
...
structural: params=3 returns=0 nesting=1 doc=false exported=false cognitive=2
...
deep: fan_in=6 fan_out=1 dead=false depth=1 instab=0.25
