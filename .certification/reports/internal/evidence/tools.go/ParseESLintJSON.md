...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/evidence/tools.go#ParseESLintJSON` |
| **Type** | function |
| **Path** | `internal/evidence/tools.go` |
| **Language** | go |
| **Symbol** | `ParseESLintJSON` |
...
32 lines (29 code, 1 comment, 2 blank), 0 TODOs, complexity 6
...
structural: params=1 returns=1 nesting=3 doc=true exported=true cognitive=9
