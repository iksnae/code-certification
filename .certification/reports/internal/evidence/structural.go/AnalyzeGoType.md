...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/evidence/structural.go#AnalyzeGoType` |
| **Type** | function |
| **Path** | `internal/evidence/structural.go` |
| **Language** | go |
| **Symbol** | `AnalyzeGoType` |
...
51 lines (43 code, 2 comment, 6 blank), 0 TODOs, complexity 16
...
structural: params=2 returns=1 nesting=3 doc=true exported=true cognitive=17
