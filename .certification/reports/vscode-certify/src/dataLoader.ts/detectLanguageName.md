...
| Field | Value |
|-------|-------|
| **Unit ID** | `ts://vscode-certify/src/dataLoader.ts#detectLanguageName` |
| **Type** | function |
| **Path** | `vscode-certify/src/dataLoader.ts` |
| **Language** | ts |
| **Symbol** | `detectLanguageName` |
...
structural: params=1 returns=1 nesting=1 doc=false exported=false cognitive=12
