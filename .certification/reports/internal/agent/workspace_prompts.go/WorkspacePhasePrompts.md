...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/agent/workspace_prompts.go#WorkspacePhasePrompts` |
| **Type** | function |
| **Path** | `internal/agent/workspace_prompts.go` |
| **Language** | go |
| **Symbol** | `WorkspacePhasePrompts` |
...
per-unit coverage: 50%

| Metric | Value |
|--------|------:|
| `unit_test_coverage` | 0.50 |
