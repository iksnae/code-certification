# 🟢 `workspace_snapshot_weight_test.go`
...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/agent/workspace_snapshot_weight_test.go` |
| **Type** | file |
| **Path** | `internal/agent/workspace_snapshot_weight_test.go` |
| **Language** | go |
...
97 lines (68 code, 18 comment, 11 blank), 0 TODOs, complexity 0
