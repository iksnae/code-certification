...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/analysis/rust_analyzer_test.go` |
| **Type** | file |
| **Path** | `internal/analysis/rust_analyzer_test.go` |
| **Language** | go |
...
199 lines (168 code, 1 comment, 30 blank), 0 TODOs, complexity 0
