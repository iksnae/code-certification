...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/analysis/ts_analyzer.go#tsHasDocComment` |
| **Type** | function |
| **Path** | `internal/analysis/ts_analyzer.go` |
| **Language** | go |
| **Symbol** | `tsHasDocComment` |
...
21 lines (19 code, 2 comment, 0 blank), 0 TODOs, complexity 9
...
structural: params=2 returns=1 nesting=3 doc=false exported=false cognitive=11
...
deep: fan_in=4 fan_out=5 dead=false depth=1 instab=0.29
