...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/agent/fallback.go#AdaptiveMessages` |
| **Type** | function |
| **Path** | `internal/agent/fallback.go` |
| **Language** | go |
| **Symbol** | `AdaptiveMessages` |
...
15 lines (12 code, 3 comment, 0 blank), 0 TODOs, complexity 2
...
deep: fan_in=4 fan_out=0 dead=true depth=1 instab=0.20
