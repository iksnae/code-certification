...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/agent/openrouter.go#Chat` |
| **Type** | method |
...
36 lines (28 code, 3 comment, 5 blank), 0 TODOs, complexity 12
...
structural: params=2 returns=2 nesting=3 doc=true exported=true cognitive=13
