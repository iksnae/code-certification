...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/analysis/ts_analyzer.go#tsAnalyzeFunction` |
| **Type** | function |
| **Path** | `internal/analysis/ts_analyzer.go` |
| **Language** | go |
| **Symbol** | `tsAnalyzeFunction` |
...
43 lines (34 code, 4 comment, 5 blank), 0 TODOs, complexity 9
...
deep: fan_in=2 fan_out=17 dead=false depth=1 instab=0.29
