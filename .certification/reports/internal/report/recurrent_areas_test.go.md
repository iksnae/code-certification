...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/report/recurrent_areas_test.go` |
| **Type** | file |
| **Path** | `internal/report/recurrent_areas_test.go` |
| **Language** | go |
...
61 lines (48 code, 8 comment, 5 blank), 0 TODOs, complexity 0
