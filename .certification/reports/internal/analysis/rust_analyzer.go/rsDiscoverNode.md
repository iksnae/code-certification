...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/analysis/rust_analyzer.go#rsDiscoverNode` |
| **Type** | function |
| **Path** | `internal/analysis/rust_analyzer.go` |
| **Language** | go |
| **Symbol** | `rsDiscoverNode` |
...
75 lines (67 code, 2 comment, 6 blank), 0 TODOs, complexity 15
...
structural: params=3 returns=1 nesting=4 doc=false exported=false cognitive=24
...
deep: fan_in=3 fan_out=10 dead=false depth=1 instab=0.29
