...
2. **Evaluate** — Deterministic evidence collected from linters, test runners, git history, code metrics
...
- **Policy-as-Code** — Versioned YAML policies you control

## Language Support

| Language | Adapter | Discovery |
|----------|---------|-----------|
| **Go** | Full AST | Functions, methods, types |
