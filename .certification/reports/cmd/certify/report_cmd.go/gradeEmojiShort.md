...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://cmd/certify/report_cmd.go#gradeEmojiShort` |
| **Type** | function |
| **Path** | `cmd/certify/report_cmd.go` |
| **Language** | go |
| **Symbol** | `gradeEmojiShort` |
...
14 lines (14 code, 0 comment, 0 blank), 0 TODOs, complexity 5
...
deep: fan_in=2 fan_out=0 dead=false depth=4 instab=1.00
