...
| Field | Value |
|-------|-------|
| **Unit ID** | `go://internal/agent/stage.go#extractJSON` |
| **Type** | function |
...
21 lines (19 code, 2 comment, 0 blank), 0 TODOs, complexity 6
...
deep: fan_in=5 fan_out=1 dead=false depth=1 instab=0.20
